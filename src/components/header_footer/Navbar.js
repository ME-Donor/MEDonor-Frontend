            ...
            <Navbar expand="lg" variant="light" className="main-navbar-hf">
                ...
                <Navbar.Collapse id="responsive-navbar-nav" className="nav-links-section-hf">
                    ...
                    <Nav className="mr-auto ">
                     ...
                     { props.role && <> 
                      ...
                      <Nav.Link eventKey={4} href='/usersList' className="navbar-main-links-hf">
                        <span className="navbar-nav-links-hf">UsersList</span></Nav.Link>
                      </> }  
                      { props.role=== "donor" && <> 
                    ...
                    { props.role != null && <>
                            ...
                            <Button variant="outline-light" onClick={props.logout} className="sign-in-btn-hf " inline style={{border: " solid #fff" , borderRadius:"20px"}}>Log out</Button>
                            {' '}</>} 
